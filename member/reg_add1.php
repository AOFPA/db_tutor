  ...
  <tbody>
    ...
    ?>
        <tr>
          ...
          <td><a class="btn btn-success" href="reg_add1.php?cus_id=<?php echo $cus_id ?>&cate_name=<?php echo $xrow['cate_name'] ?>&subject_name=<?php echo $xrow['subject_name'] ?>&system_name=<?php echo $xrow['system_name'] ?>&class_name=<?php echo $xrow['reg_class'] ?>">เลือก</a></td></tr>
    <?php
      }
    } else {
      echo "0 results";
